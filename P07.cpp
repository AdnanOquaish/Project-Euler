 ...
 *******************************************************************************/
    ...
    bool isPrime(ll i)
    {
        ...
        if(i%19==0) return false;
        if(i%23==0) return false;
        if(i%29==0) return false;
        if(i%31==0) return false;
        if(i%37==0) return false;
        if(i%41==0) return false;
        if(i%43==0) return false;
        if(i%47==0) return false;
        if(i%53==0) return false;
        if(i%59==0) return false;
